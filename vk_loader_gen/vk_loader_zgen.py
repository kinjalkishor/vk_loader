...
# open output files
fo_vk_core_h = open(path + "/gen/vk_loader_core.h","w")
fo_vk_core_cpp = open(path + "/gen/vk_loader_core.cpp","w")
fo_vk_win32_h = open(path + "/gen/vk_loader_win32.h","w")
fo_vk_win32_cpp = open(path + "/gen/vk_loader_win32.cpp","w")
